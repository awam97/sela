...
<div class="page-header-sela d-flex justify-content-between align-items-center">
    <div>
        <h1><i class='bx bxs-user-plus text-gold me-2'></i> إنشاء حساب مسؤول جديد</h1>
        <p class="text-muted small ps-5 mb-0">تجاوز الصلاحيات التقليدية وإنشاء حساب مدير تنفيذي مرشد لمدرسة معينة</p>
    </div>
...
<div class="row justify-content-center mt-5">
    <div class="col-xl-6 col-lg-8">
        <form action="<?= base_url('superadmin/admins/create') ?>" method="POST">
            <?= csrf_field() ?>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            ...
                            <div class="input-group-sela">
                                ...
                                <input type="text" name="name" class="form-control form-control-lg border-light bg-light" required placeholder="مثال: أحمد محمد علي">
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group-sela">
                                ...
                                <select name="school" class="form-select form-select-lg border-light bg-light" required>
                                    <option value="">اختر مدرسة لربطها بهذا الحساب</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group-sela">
                                ...
                                <input type="text" name="username" class="form-control form-control-lg border-light bg-light" required>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label text-muted small fw-bold">كلمة المرور المؤقتة</label>
                            <div class="input-group-sela">
                                <span class="input-group-text"><i class='bx bx-lock-alt'></i></span>
                                <input type="password" name="password" class="form-control form-control-lg border-light bg-light" required>
                            </div>
                        </div>

                        <div class="col-12">
                            <label class="form-label text-muted small fw-bold">رقم الهاتف للتواصل</label>
                            <div class="input-group-sela">
                                <span class="input-group-text"><i class='bx bx-phone'></i></span>
                                <input type="tel" id="phone" name="phone_input" class="form-control form-control-lg border-light bg-light" placeholder="09XXXXXXXX">
            ...
            <div class="mt-5">
                <button type="submit" class="btn-sela btn-sela-gold shadow-lg py-3 w-100 fs-5 rounded-pill">
                    <i class='bx bx-check-circle me-2'></i> تفعيل حساب المسؤول
                </button>
            </div>
        </form>
    </div>
