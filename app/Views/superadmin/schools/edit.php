...
<div class="page-header-sela d-flex justify-content-between align-items-center">
    <div>
        <h1><i class='bx bxs-school text-gold me-2'></i> تعديل بيانات المؤسسة</h1>
        <p class="text-muted small ps-5 mb-0">تحديث بيانات <?= $school['name'] ?> في النظام</p>
    </div>
...
<div class="row justify-content-center mt-5">
    <div class="col-xl-8">
        <form action="<?= base_url('superadmin/schools/edit/'.$school['ID']) ?>" method="POST">
            <?= csrf_field() ?>
                    ...
                    <div class="row g-4">
                        <div class="col-md-8">
                            ...
                            <div class="input-group-sela">
                                ...
                                <input type="text" name="name" value="<?= $school['name'] ?>" class="form-control form-control-lg border-light bg-light" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="input-group-sela">
                                ...
                                <select name="city" class="form-select form-select-lg border-light bg-light" required>
                                    ...
                                    <?php foreach ($cities as $city): ?>
                                        <option value="<?= $city['ID'] ?>" <?= $school['city'] == $city['ID'] ? 'selected' : '' ?>><?= $city['name'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group-sela">
                                ...
                                <input type="email" name="email" value="<?= $school['email'] ?>" class="form-control form-control-lg border-light bg-light" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group-sela">
                                ...
                                <input type="text" name="year" value="<?= $school['year'] ?>" class="form-control form-control-lg border-light bg-light" required>
                            </div>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="input-group-sela">
                                ...
                                <input type="text" name="address" value="<?= $school['address'] ?>" class="form-control form-control-lg border-light bg-light" required>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <div class="input-group-sela">
                                ...
                                <input type="text" name="manager" value="<?= $school['manager'] ?>" class="form-control form-control-lg border-light bg-light" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group-sela">
                                ...
                                <input type="text" name="exams_manager" value="<?= $school['exams_manager'] ?>" class="form-control form-control-lg border-light bg-light" required>
                            </div>
                        </div>
                    </div>
                </div>
