...
class Settings extends BaseController
{
    public function index()
    {
        ...
        $defaults = [
            ...
            // Common Mobile Labels & Buttons
            'lbl_save_attendance' => 'حفظ الحضور والغياب',
            'lbl_select_class' => 'اختر الفصل الدراسي',
            'lbl_present' => 'حاضر',
            'lbl_absent' => 'غائب',
            'lbl_late' => 'تأخر',
            'lbl_excused' => 'إجازة',
            'lbl_total_paid' => 'إجمالي المدفوعات',
            'lbl_remaining_balance' => 'المستحقات المتبقية',
            'lbl_invoices' => 'الفواتير',
            'lbl_logout' => 'تسجيل الخروج',
            'lbl_change_password' => 'تغيير كلمة المرور',
            'lbl_qr_instruction' => 'وجه الكاميرا نحو الرمز للتحقق الفوري',
            'lbl_search_student' => 'بحث باسم الطالب أو رقم القيد...',
            'lbl_save_marks' => 'حفظ ورصد الدرجات',
            'lbl_select_exam_category' => 'اختر فئة التقييم (أعمال سنة / امتحانات)',
            'lbl_success_save' => 'تم حفظ البيانات بنجاح'
        ];
